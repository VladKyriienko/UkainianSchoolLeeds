...
import { deleteOrganisation } from '@/app/(authenticated)/admin/users/actions';
import { useRouter } from 'next/navigation';
import type { AdminOrganisation } from '@/app/(authenticated)/admin/users/actions';

type OrganisationActionButtonsProps = {
  organisation: AdminOrganisation;
};

export function OrganisationActionButtons({
  organisation
}: OrganisationActionButtonsProps) {
  ...
  return (
    <>
      <Button
        ...
        size="sm"
        onClick={() =>
          router.push(`/admin/organisations/${organisation.id}/edit`)
        }
      >
        Edit
      </Button>
