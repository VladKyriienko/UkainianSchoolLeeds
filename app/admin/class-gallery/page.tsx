...
import ClassGalleryManagementTable from '../components/ClassGalleryManagementTable';
import { ClassGallerySearchForm } from '@/app/admin/components/ClassGallerySearchForm';
