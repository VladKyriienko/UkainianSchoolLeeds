  ...
  return (
    <EntityTableShell>
      <Table>
        <TableHeader>
          <TableRow>
            <TableHead className="w-[180px]">Parents (EN)</TableHead>
            <TableHead className="w-[180px]">Parents (UK)</TableHead>
            <TableHead className="w-[120px]">Date</TableHead>
            <TableHead className="min-w-[200px]">Content (EN)</TableHead>
            <TableHead className="min-w-[200px]">Content (UK)</TableHead>
