...
import { ChangeEmailDialog } from '@/app/admin/profile/components/ChangeEmailDialog';
import { ChangePasswordDialog } from '@/app/admin/profile/components/ChangePasswordDialog';
