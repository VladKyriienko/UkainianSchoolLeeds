...
type SheetContentProps = {
  ...
  /** Portal container; when set, overlay/content render inside it (e.g. to stay below header z-index) */
...
>(
  (
    ...
    <SheetPortal container={portalContainer ?? undefined}>
      <SheetOverlay className={overlayClassName} overlayStyle={overlayStyle} />
